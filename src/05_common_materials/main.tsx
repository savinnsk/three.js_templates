...
const scene = new THREE.Scene()
 scene.environment = new THREE.CubeTextureLoader().setPath("https://sbcode.net/img/").load(['px.png','nx.png','py.png','ny.png','pz.png','nz.png'])// new THREE.CubeTextureLoader().setPath('https://sbcode.net/img/').load(['px.png', 'nx.png', 'py.png', 'ny.png', 'pz.png', 'nz.png'])
