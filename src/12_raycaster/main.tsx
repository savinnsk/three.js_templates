...
import img from "./public/models/suzanne_no_material.glb"
const scene = new THREE.Scene()

new RGBELoader().load('https://sbcode.net/img/venice_sunset_1k.hdr', (texture) => {
